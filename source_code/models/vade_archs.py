...
from models.decoders import Decoder_2Dshapes, FcDecoder
from models.encoders import Encoder_2Dshapes, FcEncoder
...
class Vade2D(Vade):
    ...
    #def __init__(self):
        #super(Vade2D, self).__init__()


    def init_architecture(self):
        self.encoder = Encoder_2Dshapes(self.z_dim)
        self.decoder = Decoder_2Dshapes(self.z_dim)
        self.width = 64
        self.height = 64

class Vade_mnist(Vade):
    #def __init__(self):
        #super(Vade_mnist,self).__init__()   
    def init_architecture(self):

        self.encoder = FcEncoder(z_dim=self.z_dim)
        self.decoder = FcDecoder(z_dim=self.z_dim)
        self.width = 28
        self.height = 28
